...
banco_MATRIZ$DIA_UTIL_OU_PLANTAO = ifelse(banco_MATRIZ$TIPO_DILIGENCIA == "FISCALIZAÇÕES EM UNIDADES SOCIOEDUCATIVAS NOS FINAIS DE SEMANA E FERIADOS",
                        "PLANTÃO", banco_MATRIZ$DIA_UTIL_OU_PLANTAO)
